...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  /**
     ...
     @since 0.8.1 */
  public
  void theAssert(boolean assertion, String msg) {
    if(!assertion)
      this.error(msg);
  }
  ...
  */
  ...
  void closeNestedAppenders() {
    Enumeration enu = this.getAllAppenders();
    if(enu != null) {
      while(enu.hasMoreElements()) {
	Appender a = (Appender) enu.nextElement();
  ...
  */
  ...
  /**
     ...
     @return Enumeration An enueration of the appenders in this category.  
  */
  public
