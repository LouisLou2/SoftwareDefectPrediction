...

  ...
  /**
    * Constant: the attribute value is a token from an enueration.
    * @see #getAttributeType
    */
...

    ...
    throws java.lang.Exception
  {
    ...
    type = readAttType();
				...
				// Get the string of enuerated values
				// if necessary.
    if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
      enu = dataBufferToString();
    }

				// Read the default value.
    requireWhitespace();
    parseDefault(elementName, name, type, enu);
  }
  ...
  /**
    ...
    */
  void parseDefault (String elementName, String name, int type, String enu)
    throws java.lang.Exception
  {
    ...
    setAttribute(elementName, name, type, enu, value, valueType);
  }
...

  ...
  /**
    ...
    * parsed.
    * @return An enueration of all element types declared for this
    *         document (as Strings).
    * @see #getElementContentType
  ...
  /**
    * Retrieve the allowed values for an enuerated attribute type.
    * @param name The name of the associated element.
    * @param aname The name of the attribute.
  ...
  /**
    ...
    */
  void setAttribute (String elName, String name, int type, String enueration,
